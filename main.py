...
# bot_application = None # Já declarada como global
# bot_event_loop = None # Já declarada como global
...
# Modificada para armazenar o loop de eventos
async def start_bot():
    global bot_application, bot_event_loop # <<<--- Acessar globais
    # 1. Armazenar a referência ao loop de eventos da thread principal
    bot_event_loop = asyncio.get_running_loop() # <<<--- Correção 1
    logging.info("Loop de eventos principal armazenado.")
